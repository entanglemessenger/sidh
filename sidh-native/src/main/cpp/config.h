...
#elif defined(__LINUX__) || defined(__ANDROID__)        // Linux OS
...
#if TARGET_ARCH_ABI == x86_64
    #define TARGET TARGET_AMD64
    #define RADIX           64
    #define LOG2RADIX       6  
    typedef uint64_t        digit_t;        // Unsigned 64-bit digit
#elif TARGET_ARCH_ABI n== x86
    #define TARGET TARGET_x86
    #define RADIX           32
    #define LOG2RADIX       5  
    typedef uint32_t        digit_t;        // Unsigned 32-bit digit
#elif TARGET_ARCH_ABI == armeabi-v7a
    #define TARGET TARGET_ARM
    #define RADIX           32
    #define LOG2RADIX       5  
    typedef uint32_t        digit_t;        // Unsigned 32-bit digit
#elif TARGET_ARCH_ABI == arm64-v8a
